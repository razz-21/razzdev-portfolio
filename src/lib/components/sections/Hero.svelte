<script lang="ts">
	...
	import cvUrl from '$lib/attachments/Ernesto_Razo_CV.pdf?url';
</script>
...
<style>
	...
	@media (max-width: 700px) {
		...
		h1 {
			font-size: clamp(48px, 10.7vw, 73px);
			line-height: 1.02;
			margin-bottom: 26px;
		}
		.hero-copy p {
